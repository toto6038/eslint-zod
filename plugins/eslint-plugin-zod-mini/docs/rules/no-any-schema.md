...
This rule prevents the usage of `z.any()` in Zod Mini schemas.
Using `z.any()` eliminates the benefits of runtime type checking that Zod Mini provides, as it accepts any value without validation.
...
- Loss of Zod Mini's validation capabilities
...
If you're in the process of migrating JavaScript code to use Zod Mini and need a temporary escape hatch, you might want to disable this rule.
