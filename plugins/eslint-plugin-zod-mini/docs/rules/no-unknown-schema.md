...
This rule prevents the usage of `z.unknown()` in Zod Mini schemas.
Using `z.unknown()` bypasses Zod Mini's type validation, as it accepts any value without runtime type checking.
